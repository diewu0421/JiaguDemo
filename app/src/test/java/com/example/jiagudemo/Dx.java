...
public class Dx {
    ...
    public static void dxCommand(File aarDex, File classes_jar) throws IOException, InterruptedException {
        ...
        System.out.println("sh dx --dex --output=" + aarDex.getAbsolutePath() + " " + classes_jar.getAbsolutePath());
        String tool = System.getenv("BUILD_TOOL");
        System.out.println("tooll = " +  tool);
        Process process = runtime.exec("sh /Users/apple/Library/Android/sdk/build-tools/29.0.3/dx --dex --output=" + aarDex.getAbsolutePath() + " " +
